...
if    'iihe' in SITE :
  ...
  treeBaseDirY = '/eos/cms/store/cmst3/group/hww/HWWNano/'
  treeBaseDirJH = '/eos/user/l/lusanche/Full2017/VBF_DNNvar/400mjj700DNN/'

directory = treeBaseDirJH+'Fall2017_nAOD_v1_Full2017v2/MCl1loose2017v2__MCCorr2017__btagPerEvent__l2loose__l2tightOR2017'
...
if useEmbeddedDY: #Setup
  ...
  directory2 = treeBaseDirJH+'Fall2017_nAOD_v1_Full2017v2/MCl1loose2017v2__MCCorr2017__btagPerEvent__l2loose__l2tightOR2017__EmbeddingVeto'+skim
...
if useEmbeddedDY:
  ...
  for Run in DataRun :
          ...
          directoryEmbJH = '/eos/user/l/lusanche/Full2017/VBF_DNNvar/400mjj700DNN/Embedding2017_nAOD_v1_Full2017v2/DATAl1loose2017v2__DATACorr2017__l2loose__l2tightOR2017__Embedding2017__hadd/'
          FileTarget = getSampleFiles(directoryEmbJH,'DYToTT_MuEle_Embedded_Run2017'+Run[0],True,'nanoLatino_')
  ...
  veto_dict = {'TTTo2L2Nu'            : '(TMath::Sqrt( TMath::Exp(0.0615-0.0005*topGenPt) * TMath::Exp(0.0615-0.0005*antitopGenPt) ) )' ,
               ...
               'WZTo3LNu'  : '(Gen_ZGstar_mass>=0.1 || Gen_ZGstar_mass<0)' ,
...
for Run in DataRun :
        directory = treeBaseDirJH+'Run2017_nAOD_v1_Full2017v2/DATAl1loose2017v2__DATACorr2017__l2loose__fakeW/'
...
for Run in DataRun :
        directory = treeBaseDirJH+'Run2017_nAOD_v1_Full2017v2/DATAl1loose2017v2__DATACorr2017__l2loose/'
        for DataSet in DataSets :
                FileTarget = getSampleFiles(directory,DataSet+'_'+Run[1],True,'nanoLatino_')
                for iFile in FileTarget:
                        print(iFile)
